...
public class AntiCheat {
    ...
    //TODO Самая большая проблема будет в том, что компьютер может предоставлять поддельные данные для анти-чита. Чтобы противостоять этому, нужно синхронизировать время с сервером и проверять разницу во времени кликов на подлинность
    ...
    //TODO Дельта отклонения между временем кликов
